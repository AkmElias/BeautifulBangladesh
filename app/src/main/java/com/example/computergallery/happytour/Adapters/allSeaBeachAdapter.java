...
import com.example.computergallery.happytour.ModelClass.allSeaBeachModel;
...
public class allSeaBeachAdapter extends RecyclerView.Adapter<allSeaBeachAdapter.MyViewHolder> {

    private ArrayList<allSeaBeachModel> cultureModels;
    private Context context;
    private SQLiteHandler db;
    private SQLiteHandlerForOnePlace dbb;
    private SessionManager session;
    String place_id;
    allSeaBeachModel newsModel;
    SliderLayout sliderShow;
    private static final String TAGG = AllPlaceAdapter.class.getSimpleName();

    public allSeaBeachAdapter(Context context, List<allSeaBeachModel> postLists) {
        this.cultureModels = (ArrayList<allSeaBeachModel>) postLists;
        this.context = context;
    }


    @Override
    public allSeaBeachAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(context).inflate(R.layout.all_place_card_view, parent, false);
        allSeaBeachAdapter.MyViewHolder holder = new allSeaBeachAdapter.MyViewHolder(view, context, cultureModels);
        return holder;
    }

    @Override
    public void onBindViewHolder(final allSeaBeachAdapter.MyViewHolder holder, int position) {
        final allSeaBeachModel newsModel = cultureModels.get(position);
...
//                .into(holder.imageView);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ImageView imageView;
        ArrayList<allSeaBeachModel> postLists = new ArrayList<>();
        ProgressWheel progressWheel;
        Context context;

        public MyViewHolder(View itemView, Context context, ArrayList<allSeaBeachModel> postLists) {
            super(itemView);
            this.context = context;
